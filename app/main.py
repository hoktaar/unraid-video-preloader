...
TRANSLATIONS = {
    "en": {
        ...
        "info_tautulli": "Tautulli loads media based on selected strategies",
        "caching_strategies": "Caching Strategies",
        "recent_releases": "Newest Releases",
        "recent_releases_desc": "By release date (premiere)",
        "most_watched": "Most Watched",
        "most_watched_desc": "By watch count (last 30 days)",
        "recently_added": "Recently Added",
        "recently_added_desc": "By date added to library",
        "movies_count": "Movies",
        "shows_count": "Series",
        ...
        # Settings help texts
        "help": "Help",
        "help_paths_video": "Paths to your media (comma-separated)",
        "help_paths_priority": "These will be loaded first",
        "help_paths_exclude": "Folders that will be skipped (e.g. */Samples/*)",
        "help_preload_head": "How many MB from the start of the file will be loaded (for quick start)",
        "help_preload_tail": "MB from the end (for seek preview)",
        "help_preload_threshold": "Files with read time below this value are considered cached",
        # Help page texts
        "help_intro": "The Video Preloader strategically loads important parts of video files into RAM cache to enable instant playback without buffering - perfect for Plex/Jellyfin on Unraid.",
        "help_how_title": "How does it work?",
        "help_step1_title": "Scan files",
        "help_step1_desc": "The preloader scans the configured paths for video files.",
        "help_step2_title": "Load strategically",
        "help_step2_desc": "The first MB (head) and last MB (tail) of each file are loaded into RAM.",
        "help_step3_title": "Play instantly",
        "help_step3_desc": "Videos start instantly without buffering since the important parts are already in RAM.",
        "help_features_title": "Features",
        "help_feat_tautulli": "Automatically caches the most popular movies and latest series based on playback statistics.",
        "help_feat_live": "Detects active series streams and automatically preloads the next episodes.",
        "help_feat_scheduler": "Runs preloads automatically on schedule (cron format).",
        "help_feat_plex": "Responds to Plex events and caches media on demand.",
        "help_strategies_title": "Caching Strategies",
        "help_strat_recent": "Movies and series sorted by release date. Ideal for new blockbusters and current series.",
        "help_strat_watched": "The most popular content of the last 30 days. Perfect for evergreens and favorite movies.",
        "help_strat_added": "Freshly added content to the library. For new downloads.",
        "help_mappings_title": "Path Mappings",
        "help_mappings_desc": "If Plex/Tautulli sees different paths than the container, you need to configure mappings:",
        "help_mappings_tip": "Tip: Check the logs for '⚠️ Path not found' to find the correct mappings.",
        "help_troubleshoot_title": "Troubleshooting",
        "help_ts_nocache_title": "Files are not being cached",
        "help_ts_nocache_1": "Check if paths are correctly mounted",
        "help_ts_nocache_2": "Make sure files are larger than 'Min. File Size'",
        "help_ts_nocache_3": "Check RAM usage (too high = no new files)",
        "help_ts_live_title": "Live monitoring finds no episodes",
        "help_ts_live_1": "Configure path mappings (Plex paths ≠ container paths)",
        "help_ts_live_2": "Check if Tautulli API key is correct",
        "help_ts_live_3": "Test with '/api/test-live-monitoring'",
        "help_ts_tautulli_title": "Tautulli connection fails",
        "help_ts_tautulli_1": "Check the Tautulli URL (incl. port, e.g. http://tautulli:8181)",
        "help_ts_tautulli_2": "Find API key in Tautulli → Settings → Web Interface",
        "help_ts_tautulli_3": "Make sure containers can reach each other (same Docker network)",
        "help_apikeys_title": "Finding API Keys",
        "help_tautulli_key_title": "Tautulli API Key",
        "help_tautulli_key_1": "Open Tautulli in browser",
        "help_tautulli_key_2": "Go to",
        "help_tautulli_key_3": "Scroll down to",
        "help_tautulli_key_4": "Copy the key (or click 'Show' to display it)",
        "help_tautulli_key_tip": "If no key exists, click 'Generate' to create a new one.",
        "help_plex_token_title": "Plex Token (X-Plex-Token)",
        "help_plex_method1": "Method 1: Via Browser (easy)",
        "help_plex_method1_1": "Open Plex Web App and play any media",
        "help_plex_method1_2": "Click on",
        "help_plex_method1_3": "Click on",
        "help_plex_method1_4": "In the URL you'll see:",
        "help_plex_method2": "Method 2: Via Plex Account",
        "help_plex_method2_1": "Go to",
        "help_plex_method2_2": "Log in (if not logged in)",
        "help_plex_method2_3": "Search in the XML for",
        "help_plex_token_warning": "Never share your token publicly! It gives full access to your Plex server.",
    },
    "de": {
        "title": "Video Preloader",
        ...
        "info_tautulli": "Tautulli lädt Medien basierend auf gewählten Strategien",
        "caching_strategies": "Caching-Strategien",
        "recent_releases": "Neueste Releases",
        "recent_releases_desc": "Nach Erscheinungsdatum (Premiere)",
        "most_watched": "Meistgesehen",
        "most_watched_desc": "Nach Wiedergabe-Anzahl (letzte 30 Tage)",
        "recently_added": "Zuletzt hinzugefügt",
        "recently_added_desc": "Nach Hinzufüge-Datum zur Bibliothek",
        "movies_count": "Filme",
        "shows_count": "Serien",
        "live_monitoring": "Live-Monitoring",
        ...
        # Settings help texts
        "help": "Hilfe",
        "help_paths_video": "Pfade zu deinen Medien (kommasepariert)",
        "help_paths_priority": "Diese werden zuerst geladen",
        "help_paths_exclude": "Ordner die übersprungen werden (z.B. */Samples/*)",
        "help_preload_head": "Wie viel MB vom Anfang der Datei geladen wird (für schnellen Start)",
        "help_preload_tail": "MB vom Ende (für Seek-Vorschau)",
        "help_preload_threshold": "Dateien mit Lesezeit unter diesem Wert gelten als gecached",
        # Help page texts
        "help_intro": "Der Video Preloader lädt strategisch wichtige Teile von Videodateien in den RAM-Cache, um sofortiges Starten ohne Buffering zu ermöglichen - perfekt für Plex/Jellyfin auf Unraid.",
        "help_how_title": "Wie funktioniert es?",
        "help_step1_title": "Dateien scannen",
        "help_step1_desc": "Der Preloader durchsucht die konfigurierten Pfade nach Videodateien.",
        "help_step2_title": "Strategisch laden",
        "help_step2_desc": "Die ersten MB (Head) und letzten MB (Tail) jeder Datei werden in den RAM geladen.",
        "help_step3_title": "Sofort abspielen",
        "help_step3_desc": "Videos starten sofort ohne Buffering, da die wichtigen Teile bereits im RAM sind.",
        "help_features_title": "Features",
        "help_feat_tautulli": "Cached automatisch die beliebtesten Filme und neuesten Serien basierend auf Wiedergabestatistiken.",
        "help_feat_live": "Erkennt aktive Serien-Streams und lädt automatisch die nächsten Episoden vor.",
        "help_feat_scheduler": "Führt Preloads automatisch nach Zeitplan aus (Cron-Format).",
        "help_feat_plex": "Reagiert auf Plex-Events und cached Medien bei Bedarf.",
        "help_strategies_title": "Caching-Strategien",
        "help_strat_recent": "Filme und Serien sortiert nach Erscheinungsdatum. Ideal für neue Blockbuster und aktuelle Serien.",
        "help_strat_watched": "Die beliebtesten Inhalte der letzten 30 Tage. Perfekt für Dauerbrenner und Lieblingsfilme.",
        "help_strat_added": "Frisch zur Bibliothek hinzugefügte Inhalte. Für neue Downloads.",
        "help_mappings_title": "Pfad-Mappings",
        "help_mappings_desc": "Wenn Plex/Tautulli andere Pfade sieht als der Container, musst du Mappings konfigurieren:",
        "help_mappings_tip": "Tipp: Schau in die Logs nach '⚠️ Pfad nicht gefunden' um die richtigen Mappings zu finden.",
        "help_troubleshoot_title": "Troubleshooting",
        "help_ts_nocache_title": "Dateien werden nicht gecached",
        "help_ts_nocache_1": "Prüfe ob die Pfade korrekt gemountet sind",
        "help_ts_nocache_2": "Stelle sicher, dass die Dateien größer als 'Min. File Size' sind",
        "help_ts_nocache_3": "Prüfe die RAM-Auslastung (zu hoch = keine neuen Dateien)",
        "help_ts_live_title": "Live-Monitoring findet keine Episoden",
        "help_ts_live_1": "Konfiguriere Pfad-Mappings (Plex-Pfade ≠ Container-Pfade)",
        "help_ts_live_2": "Prüfe ob Tautulli API-Key korrekt ist",
        "help_ts_live_3": "Teste mit '/api/test-live-monitoring'",
        "help_ts_tautulli_title": "Tautulli-Verbindung schlägt fehl",
        "help_ts_tautulli_1": "Prüfe die Tautulli URL (inkl. Port, z.B. http://tautulli:8181)",
        "help_ts_tautulli_2": "API-Key findest du in Tautulli → Settings → Web Interface",
        "help_ts_tautulli_3": "Stelle sicher, dass Container sich erreichen können (gleiche Docker Network)",
        "help_apikeys_title": "API-Keys finden",
        "help_tautulli_key_title": "Tautulli API-Key",
        "help_tautulli_key_1": "Öffne Tautulli im Browser",
        "help_tautulli_key_2": "Gehe zu",
        "help_tautulli_key_3": "Scrolle runter zu",
        "help_tautulli_key_4": "Kopiere den Key (oder klicke 'Show' um ihn anzuzeigen)",
        "help_tautulli_key_tip": "Falls kein Key vorhanden, klicke auf 'Generate' um einen neuen zu erstellen.",
        "help_plex_token_title": "Plex Token (X-Plex-Token)",
        "help_plex_method1": "Methode 1: Über Browser (einfach)",
        "help_plex_method1_1": "Öffne Plex Web App und spiele irgendein Medium ab",
        "help_plex_method1_2": "Klicke auf",
        "help_plex_method1_3": "Klicke auf",
        "help_plex_method1_4": "In der URL siehst du:",
        "help_plex_method2": "Methode 2: Über Plex Account",
        "help_plex_method2_1": "Gehe zu",
        "help_plex_method2_2": "Logge dich ein (falls nicht eingeloggt)",
        "help_plex_method2_3": "Suche in der XML nach",
        "help_plex_token_warning": "Teile deinen Token niemals öffentlich! Er gibt vollen Zugriff auf deinen Plex Server.",
    }
}
...
class Config(BaseModel):
    ...
    # Caching-Strategien (jeweils aktivierbar mit eigener Anzahl)
    # 1. Neueste Releases (nach Erscheinungsdatum)
    cache_recent_releases: bool = True
    cache_recent_movies_count: int = 20
    cache_recent_shows_count: int = 20

    # 2. Meistgesehene (nach Watch-Count)
    cache_most_watched: bool = False
    cache_most_watched_movies_count: int = 20
    cache_most_watched_shows_count: int = 20

    # 3. Zuletzt hinzugefügt (nach Hinzufüge-Datum zur Bibliothek)
    cache_recently_added: bool = False
    cache_recently_added_movies_count: int = 20
    cache_recently_added_shows_count: int = 20
...
async def fetch_tautulli_data() -> Dict[str, List[str]]:
    """
    Holt Daten von Tautulli basierend auf aktiven Caching-Strategien.

    Strategien:
    - recent_releases: Nach Erscheinungsdatum sortiert
    - most_watched: Nach Wiedergabe-Anzahl sortiert
    - recently_added: Nach Hinzufüge-Datum sortiert

    Returns:
        Dict mit allen gefundenen Dateipfaden nach Kategorie.
    """
    result = {
        "recent_movies": [], "recent_shows": [],
        "watched_movies": [], "watched_shows": [],
        "added_movies": [], "added_shows": []
    }
    ...
    async with httpx.AsyncClient(timeout=90.0) as client:
        try:
            ...
            # === STRATEGIE 1: Neueste Releases (nach Erscheinungsdatum) ===
            if config.cache_recent_releases:
                await _fetch_by_order(
                    client, base_url, movie_sections, show_sections,
                    "originally_available_at", "desc",
                    config.cache_recent_movies_count, config.cache_recent_shows_count,
                    result, "recent_movies", "recent_shows"
                )
                logger.info(f"📅 Neueste Releases: {len(result['recent_movies'])} Filme, {len(result['recent_shows'])} Serien")

            # === STRATEGIE 2: Meistgesehen (nach Watch-Count) ===
            if config.cache_most_watched:
                await _fetch_most_watched(
                    client, base_url,
                    config.cache_most_watched_movies_count,
                    config.cache_most_watched_shows_count,
                    result
                )
                logger.info(f"👀 Meistgesehen: {len(result['watched_movies'])} Filme, {len(result['watched_shows'])} Serien")

            # === STRATEGIE 3: Zuletzt hinzugefügt (nach Added-Datum) ===
            if config.cache_recently_added:
                await _fetch_by_order(
                    client, base_url, movie_sections, show_sections,
                    "added_at", "desc",
                    config.cache_recently_added_movies_count, config.cache_recently_added_shows_count,
                    result, "added_movies", "added_shows"
                )
                logger.info(f"➕ Zuletzt hinzugefügt: {len(result['added_movies'])} Filme, {len(result['added_shows'])} Serien")
...
async def _fetch_by_order(
    ...
    """
    Hilfsfunktion: Holt Filme/Serien sortiert nach einer Spalte.
    """
    # Filme
    for section_id in movie_sections:
        ...
        if resp.status_code == 200:
            ...
            if data.get("response", {}).get("result") == "success":
                ...
                for movie in movies:
                    if len(result[movies_key]) >= movies_count:
                        break
                    rating_key = movie.get("rating_key")
                    if rating_key:
                        file_path = await _find_media_file(client, base_url, rating_key)
                        if file_path and file_path not in result[movies_key]:
                            result[movies_key].append(file_path)

    # Serien (erste Episode)
    for section_id in show_sections:
        ...
        if resp.status_code == 200:
            ...
            if data.get("response", {}).get("result") == "success":
                ...
                for show in shows:
                    if len(result[shows_key]) >= shows_count:
                        break
                    ...
                    if show_key:
                        ...
                        for ep in first_eps:
                            if ep not in result[shows_key]:
                                result[shows_key].append(ep)


async def _fetch_most_watched(
    client: httpx.AsyncClient,
    base_url: str,
    movies_count: int,
    shows_count: int,
    ...
    """
    Hilfsfunktion: Holt meistgesehene Filme und Serien.
    """
    # Meistgesehene Filme (letzte 30 Tage)
    resp = await client.get(
        f"{base_url}/api/v2",
        params={
            "apikey": config.tautulli_api_key,
    ...
    if resp.status_code == 200:
        ...
        if data.get("response", {}).get("result") == "success":
            ...
            for movie in rows:
                ...
                if rating_key:
                    file_path = await _find_media_file(client, base_url, rating_key)
                    if file_path and file_path not in result["watched_movies"]:
                        result["watched_movies"].append(file_path)

    # Meistgesehene Serien (letzte 30 Tage)
    resp = await client.get(
        f"{base_url}/api/v2",
        params={
            "apikey": config.tautulli_api_key,
    ...
    if resp.status_code == 200:
        ...
        if data.get("response", {}).get("result") == "success":
            rows = data.get("response", {}).get("data", {}).get("rows", [])
            for show in rows:
                show_key = show.get("grandparent_rating_key") or show.get("rating_key")
                if show_key:
                    first_eps = await _find_next_episodes(
                        client, base_url, show_key,
                        last_season=0, last_episode=0, max_episodes=1
                    ...
                    for ep in first_eps:
                        if ep not in result["watched_shows"]:
                            result["watched_shows"].append(ep)
...
async def run_preload(source: str = "manual"):
    ...
    try:
        ...
        # 1. Tautulli-Daten (höchste Priorität) - alle aktiven Strategien
        if config.tautulli_enabled:
            state.current_action = "Fetching Tautulli data..."
            tautulli_data = await fetch_tautulli_data()
            # Alle Strategien hinzufügen (Duplikate werden später gefiltert)
            files_to_check.extend(tautulli_data.get("recent_movies", []))
            files_to_check.extend(tautulli_data.get("recent_shows", []))
            files_to_check.extend(tautulli_data.get("watched_movies", []))
            files_to_check.extend(tautulli_data.get("watched_shows", []))
            files_to_check.extend(tautulli_data.get("added_movies", []))
            files_to_check.extend(tautulli_data.get("added_shows", []))
...
async def save_config_all(
    ...
    # Caching-Strategien
    cache_recent_releases: bool = Form(False),
    cache_recent_movies_count: int = Form(20),
    cache_recent_shows_count: int = Form(20),
    cache_most_watched: bool = Form(False),
    cache_most_watched_movies_count: int = Form(20),
    cache_most_watched_shows_count: int = Form(20),
    cache_recently_added: bool = Form(False),
    cache_recently_added_movies_count: int = Form(20),
    cache_recently_added_shows_count: int = Form(20),
    # Live-Monitoring
    ...
    # Caching-Strategien
    config.cache_recent_releases = cache_recent_releases
    config.cache_recent_movies_count = cache_recent_movies_count
    config.cache_recent_shows_count = cache_recent_shows_count
    config.cache_most_watched = cache_most_watched
    config.cache_most_watched_movies_count = cache_most_watched_movies_count
    config.cache_most_watched_shows_count = cache_most_watched_shows_count
    config.cache_recently_added = cache_recently_added
    config.cache_recently_added_movies_count = cache_recently_added_movies_count
    config.cache_recently_added_shows_count = cache_recently_added_shows_count
